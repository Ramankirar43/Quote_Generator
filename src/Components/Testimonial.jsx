...
const Testimonial = (props) => {
  ...
  return (
    <div className="flex flex-col w-[85vw] md:w-[700px] bg-white justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl rounded-md">
      ...
      <div className="flex text-3xl mt-5 gap-3 text-violet-500 font-bold mx-auto text-center">
        <button
      ...
      <div className="mt-6">
        <button
          className="bg-violet-600 hover:bg-blue-500 transition-all duration-200 cursor-pointer px-10 py-2 rounded-md font-bold text-white text-lg"
